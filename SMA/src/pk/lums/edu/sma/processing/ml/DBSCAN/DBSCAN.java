...
/**
 * <!-- globalinfo-start --> Basic implementation of DBSCAN clustering algorithm
 * that should *not* be used as a reference for runtime benchmarks: more
 * sophisticated implementations exist! Clustering of new instances is not
 * supported. More info:<br/>
 * <br/>
 * Martin Ester, Hans-Peter Kriegel, Joerg Sander, Xiaowei Xu: A Density-Based
 ...
 */
public class DBSCAN extends AbstractClusterer implements OptionHandler,
     ...
     */
    private String database_distanceType = "pk.lums.edu.sma.processing.ml.DBSCAN.EuclideanDataObject";

    /**
     * Holds the type of the used database (default =
     * weka.clusterers.forOPTICSAndDBScan.Databases.SequentialDatabase)
     */
    private String database_Type = "pk.lums.edu.sma.processing.ml.DBSCAN.SequentialDatabase";
	...
	Instances filteredInstances = Filter.useFilter(instances,
	...
	vector.addElement(new Option("\tepsilon (default = 0.9)", "E", 1,
		"-E <double>"));
	vector.addElement(new Option("\tminPoints (default = 6)", "M", 1,
		"-M <int>"));
     ...
     */
    public DataObject dataObjectForName(String database_distanceType,
	    Instance instance, String key, Database database) {
	Object o = null;

	Constructor co = null;
	try {
	    co = (Class.forName(database_distanceType))
		    .getConstructor(new Class[] { Instance.class, String.class,
			    Database.class });
	...
	result.setValue(Field.AUTHOR,
		"Martin Ester and Hans-Peter Kriegel and Joerg Sander and Xiaowei Xu");
	result.setValue(
		Field.TITLE,
	...
	stringBuffer
		.append("DBSCAN clustering results\n"
			+ "========================================================================================\n\n");
	...
	stringBuffer.append("Epsilon: " + getEpsilon() + "; minPoints: "
		+ getMinPoints() + "\n");
	    ...
	    stringBuffer
		    .append("("
			    + Utils.doubleToString(
				    Double.parseDouble(dataObject.getKey()),
				    (Integer.toString(database.size()).length()),
				    0)
			    + ".) "
