...
public class EpsilonRange_ListElement implements RevisionHandler {
    ...
    /**
     * Constructs a new Element that is stored in the ArrayList which is built
     * in the k_nextNeighbourQuery-method from a specified database. This
     * structure is chosen to deliver not only the DataObjects that are within
     * the epsilon-range but also deliver the distances that were calculated.
     * This reduces the amount of distance-calculations within some
