...
public class PriorityQueue implements RevisionHandler {
	...
	PriorityQueueElement recentlyInsertedElement = (PriorityQueueElement) queue
		.get(a - 1);

	while (c > 0
		&& getPriority(c - 1) < recentlyInsertedElement.getPriority()) {
	...
	PriorityQueueElement priorityQueueElement = (PriorityQueueElement) queue
		.get(a - 1);
	...
	while (c <= size()
		&& getPriority(c - 1) > priorityQueueElement.getPriority()) {
